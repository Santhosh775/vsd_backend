...
const multipleProductBoxRoute = require('./router/multipleProductBoxRoute');
const productCountRoute = require('./router/productCountRoute');
...
app.use('/api/v1/multiple-product-box', multipleProductBoxRoute);
app.use('/api/v1/product-count', productCountRoute);
