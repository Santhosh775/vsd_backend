...
exports.createProduct = async (req, res) => {
    try {
        const { product_name, product_short, net_weight, category_id, unit, current_price, product_status, packing_type } = req.body;
...
exports.updateProduct = async (req, res) => {
    try {
        ...
        let updateData = { product_name, product_short, net_weight, category_id, unit, product_status, packing_type };
